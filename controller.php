...
if (isset($_POST['action']) && $_POST['action']=='listLivres') {   //je recois la requete ajax pour afficher les véhicules
...
if ( ($_GET['action']=='addLivre') && !empty($_POST) ) {
...
if ( ($_GET['action']=='updateLivre') && !empty($_POST) ) {
...
if ( ($_GET['action']=='addAbonne') && !empty($_POST) ) {
